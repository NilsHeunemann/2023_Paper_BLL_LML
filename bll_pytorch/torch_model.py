...
class JointModel(nn.Module):
    def __init__(self, architecture):
        ...
        self.hidden = nn.Sequential(*(layer(**specs) for layer, specs in architecture[:-1]))
        self.last_layer = architecture[-1][0](**architecture[-1][1])  # Last layer without activation
